// Version 4.0 - using ADdafruit sdc30 lib
#include <Wire.h>
//#define I2C_SDA 21
//#define I2C_SCL 22
...
float barometerAltitude = BAROMETERAltitude ; // meters ... map readings + barometer position
...
// http://192.168.x.x/light/0?\mode\:\color\red\255,"green\":\" + green_s\",\"blue\":\"255\",\"gain\":\"100\",\"white\":\"0\",\"effect\":\"0\",\"turn\":\"on\",\"transition\":\"500\"}");
   ...
   //String shelly_cmd = "/color/0?turn=on&red=255&green=255&blue=0&white=0";
    ...
    int httpResponseCode = http.POST(shelly_cmd);
...
void setup(void) {
  ...
  Serial.println("Version 4.0 Beta");
  Serial.println("");
...
//  }
  ...
  while (status != WL_CONNECTED) {
    ...
    display.println("Version 4.0 Beta");
